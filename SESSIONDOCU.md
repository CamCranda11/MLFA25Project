...
# Session 8 - 11/26/25, 3:00 PM
I have made some UX changes, including making it so users can search by song name and/or artist, as well as showing the song the recommendations are based off of when viewing the recommendations. I also removed some clutter and added some CSS changes to make the web app look a little more professional. **This is my deliverable for my Machine Learning Final Project**, but I do have some additions I would like to make in the future.
